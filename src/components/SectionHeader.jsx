...
function SectionHeader({ number, title, description, kicker, theme }) {
  const themeClass = theme ? `deck-divider-${theme}` : "";

  return (
    <Reveal className={`section-header deck-divider ${themeClass} relative mb-7 overflow-hidden lg:mb-10`}>
