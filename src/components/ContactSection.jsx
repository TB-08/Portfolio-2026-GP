      ...
      <div className="page-wrap relative">
        ...
        <Reveal className="grid gap-12 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          <div className="min-w-0">
            ...
            <h2 className="display-title mt-5 text-[2.6rem] xs:text-[3.2rem] uppercase leading-[0.95] text-white sm:text-[6.5rem] lg:text-[6rem]">
              Thank You
              <span className="block text-outline opacity-80 mt-2">For Watching</span>
            </h2>
          </div>

          <div className="group relative min-w-0 overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-[#0B1630]/90 to-[#040A18]/90 p-5 shadow-2xl backdrop-blur-3xl transition-all duration-700 hover:border-[#5D85DB]/40 hover:bg-gradient-to-br hover:from-[#0E1F42]/90 hover:to-[#050C1D]/90 hover:shadow-[0_30px_60px_rgba(93,133,219,0.15)] sm:p-12">
            {/* Ambient Glow */}
